    ...
    <>
      ...
      <section className="bg-coffee-dark px-8 pt-20 pb-24 md:pt-24 md:pb-32 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[760px] mx-auto">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-[0.72rem] tracking-[0.18em] uppercase text-cream/85 no-underline mb-12 hover:text-cream transition-colors"
          >
          ...
          {post.category && (
            <span className="inline-block text-[0.62rem] tracking-[0.26em] uppercase text-coffee-light border border-coffee-light/40 px-3 py-1.5 mb-6">
              {post.category}
            </span>
          )}
          ...
          <div className="flex items-center gap-4 text-[0.72rem] tracking-[0.12em] uppercase text-cream/60">
      ...
      <article className={`max-w-[760px] mx-auto px-6 ${post.cover_image_url ? 'pt-16' : '-mt-12 relative z-20'} pb-16`}>
        ...
        >
          ...
          <div
            className="post-content text-[0.96rem] text-text-main leading-[2.05]"
        ...
        <nav className="max-w-[1080px] mx-auto px-6 pb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {prev ? (
              ...
              >
                <div className="flex items-center gap-2 text-[0.6rem] tracking-[0.24em] uppercase text-coffee-light mb-3">
            ...
            {next ? (
              <Link
                ...
                style={{ boxShadow: '0 4px 18px rgba(74,55,40,0.06)' }}
              >
                <div className="flex items-center md:justify-end gap-2 text-[0.6rem] tracking-[0.24em] uppercase text-coffee-light mb-3">
                  Sonraki Yazı
                  <svg className="w-3.5 h-3.5 transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
