    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Çocuk, ergen ve genç yetişkinler için bireysel terapi.
            Bilişsel Davranışçı Terapi · Deneyimsel Oyun Terapisi.
          </p>
        </div>
        ...
        >
          <span style={{ color: 'rgba(250,247,242,0.4)', fontSize: 14, letterSpacing: '1px' }}>
            handepehlivan.org
          </span>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <span style={{ color: '#FAF7F2', fontSize: 18, fontStyle: 'italic', fontFamily: 'Georgia, serif' }}>
              Hande Pehlivan
            </span>
          </div>
        </div>
