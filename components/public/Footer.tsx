        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <div className="flex flex-col">
              <span className="block font-serif text-[1.15rem] text-cream leading-none">Hande Pehlivan</span>
              <span className="block text-[0.78rem] text-cream/50 tracking-[0.15em] uppercase mt-0.5">Klinik Psikolog</span>
            </div>
          </div>
