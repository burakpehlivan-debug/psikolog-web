        ...
        <div>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex flex-col justify-center gap-[4px]">
              <span className="block font-serif italic text-[1.15rem] text-cream leading-none">Hande Pehlivan</span>
              <span className="block font-sans font-light text-[0.78rem] text-cream/50 tracking-[0.15em] uppercase leading-none">Klinik Psikolog</span>
            </div>
          </div>
